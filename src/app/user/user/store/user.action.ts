...
import { DisplayMessage } from './user.state';


//actions to display message after some action
export const resetDisplayMessage = createAction('[User] resetDisplayMessage');
export const displayMessage = createAction('[User] displayMessage', props<{ data: DisplayMessage }>());
